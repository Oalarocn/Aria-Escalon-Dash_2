...
(function () {
  ...
  function buildDoc() {
    var fecha = fechaEsFromInput(el.dateInput && el.dateInput.value);
    return window.AriaReport.buildDocDefinition(state.records, { fecha: fecha });
  }
  ...
  function downloadPdf() {
    ...
    try {
      var dd = buildDoc();
      var name = 'Aria_Escalon_Disponibilidad_' + fileStamp(el.dateInput && el.dateInput.value) + '.pdf';
